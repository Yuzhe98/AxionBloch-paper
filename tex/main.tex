...
We model such interaction along with the usual magnetic interactions using spin-evolution (Bloch) equations. 
...
Calibrations are made against known analytical results and experimental data, ensuring the accuracy of the simulated signals. 
