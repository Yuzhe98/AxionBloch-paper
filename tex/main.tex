...
The simulated pseudomagnetic fields and the amplitude of the induced transverse magnetization are shown in \cref{fig:MilkyWayAxionHalo}, in which we can find the signal increasing with time at the beginning of the simulation due to axion field gradient, and then decaying due to the $T_1$ relaxation. 
