...
\begin{table*}
    ...
    Here $\nu_L$ stands for Larmor frequency, determined by the bias magnetic field. 
    ...
    % $\chi^2$ can be even smaller by using smaller step size at the cost of runtime consumption. 
    Finer step sizes yield lower $\chi^2$ at increased computational cost. 
    More technical details of the calibrations can be found in the test script suite. 
    }
