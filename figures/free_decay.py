...
timeStamp_s = data["timeStamp_s"]  # timeStamp_s.shape (5050,)
B_vec = data["B_vec"][0]  # data["B_vec"].shape : tuple((1, 5050, 3)) [len=3]
M = data["trjry"][0]  # data["trjry"].shape : tuple((1, 5051, 3)) [len=3]
...
for i, ax in enumerate([pulse_ax]):
    ...
    ax.text(-0.2, 1.07, letters[i], transform=ax.transAxes)
# ha = 'left' or 'right'
# va = 'top' or 'bottom'
# plt.tight_layout()
