...
\PY{g+go}{Define a quantity from scalar and unit}
\PY{g+gp}{\PYZgt{}\PYZgt{}\PYZgt{} }\PY{k+kn}{from} \PY{n+nn}{axionbloch}\PY{n+nn}{.}\PY{n+nn}{enphylope} \PY{k+kn}{import} \PY{n}{PhysicalQuantity}
\PY{g+gp}{\PYZgt{}\PYZgt{}\PYZgt{} }\PY{n}{B} \PY{o}{=} \PY{n}{PhysicalQuantity}\PY{p}{(}\PY{l+m+mf}{1.0}\PY{p}{,} \PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{Gauss}\PY{l+s+s2}{\PYZdq{}}\PY{p}{)}
\PY{g+gp}{\PYZgt{}\PYZgt{}\PYZgt{} }\PY{n}{B}\PY{o}{.}\PY{n}{to}\PY{p}{(}\PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{tesla}\PY{l+s+s2}{\PYZdq{}}\PY{p}{)}
\PY{g+go}{\PYZlt{}0.0001 tesla\PYZgt{}}

\PY{g+go}{Import a constant and use it with scalars}
\PY{g+gp}{\PYZgt{}\PYZgt{}\PYZgt{} }\PY{k+kn}{from} \PY{n+nn}{axionbloch}\PY{n+nn}{.}\PY{n+nn}{constants} \PY{k+kn}{import} \PY{n}{gamma\PYZus{}p}
\PY{g+gp}{\PYZgt{}\PYZgt{}\PYZgt{} }\PY{k+kn}{import} \PY{n+nn}{numpy} \PY{k}{as} \PY{n+nn}{np}
\PY{g+gp}{\PYZgt{}\PYZgt{}\PYZgt{} }\PY{n}{t90} \PY{o}{=} \PY{n}{np}\PY{o}{.}\PY{n}{pi} \PY{o}{/} \PY{l+m+mi}{2} \PY{o}{/} \PY{p}{(}\PY{n}{gamma\PYZus{}p} \PY{o}{*} \PY{n}{B}\PY{p}{)}
\PY{g+gp}{\PYZgt{}\PYZgt{}\PYZgt{} }\PY{n}{t90}\PY{o}{.}\PY{n}{to}\PY{p}{(}\PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{microsecond}\PY{l+s+s2}{\PYZdq{}}\PY{p}{)}
\PY{g+go}{\PYZlt{}58.71648792722992 microsecond\PYZgt{}}

\PY{g+go}{Operation on an array of quantities with numpy}
\PY{g+gp}{\PYZgt{}\PYZgt{}\PYZgt{} }\PY{n}{tStamps} \PY{o}{=} \PY{n}{np}\PY{o}{.}\PY{n}{array}\PY{p}{(}\PY{p}{[}\PY{l+m+mi}{0}\PY{p}{,} \PY{l+m+mi}{1} \PY{o}{/} \PY{l+m+mi}{3}\PY{p}{,} \PY{l+m+mi}{1}\PY{p}{]}\PY{p}{)} \PY{o}{*} \PY{n}{t90}
\PY{g+gp}{\PYZgt{}\PYZgt{}\PYZgt{} }\PY{n}{phases} \PY{o}{=} \PY{p}{(}\PY{n}{gamma\PYZus{}p} \PY{o}{*} \PY{n}{B} \PY{o}{*} \PY{n}{tStamps}\PY{p}{)}\PY{o}{.}\PY{n}{to}\PY{p}{(}\PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{\PYZdq{}}\PY{p}{)}
\PY{g+gp}{\PYZgt{}\PYZgt{}\PYZgt{} }\PY{n}{np}\PY{o}{.}\PY{n}{sin}\PY{p}{(}\PY{n}{phases}\PY{p}{)}
\PY{g+go}{\PYZlt{}[0.0 0.49999999999999983 1.0] dimensionless\PYZgt{}}
\end{Verbatim}
\end{varwidth}
\end{document}
