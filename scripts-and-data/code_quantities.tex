...
\PY{g+gp}{\PYZgt{}\PYZgt{}\PYZgt{} }\PY{k+kn}{from} \PY{n+nn}{astropy} \PY{k+kn}{import} \PY{n}{units} \PY{k}{as} \PY{n}{u}
\PY{g+gp}{\PYZgt{}\PYZgt{}\PYZgt{} }\PY{n}{B} \PY{o}{=} \PY{l+m+mf}{1.0} \PY{o}{*} \PY{n}{u}\PY{o}{.}\PY{n}{gauss}
...
\PY{g+gp}{\PYZgt{}\PYZgt{}\PYZgt{} }\PY{n}{t90}\PY{o}{.}\PY{n}{to}\PY{p}{(}\PY{n}{u}\PY{o}{.}\PY{n}{microsecond}\PY{p}{)}  
...
\PY{g+gp}{\PYZgt{}\PYZgt{}\PYZgt{} }\PY{n}{phases} \PY{o}{=} \PY{n}{gamma\PYZus{}p} \PY{o}{*} \PY{n}{B} \PY{o}{*} \PY{n}{tStamps} \PY{o}{*} \PY{n}{u}\PY{o}{.}\PY{n}{radian}
