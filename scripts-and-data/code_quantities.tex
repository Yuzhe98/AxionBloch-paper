...
\PY{g+gp}{\PYZgt{}\PYZgt{}\PYZgt{} }\PY{k+kn}{from} \PY{n+nn}{astropy} \PY{k+kn}{import} \PY{n}{units} \PY{k}{as} \PY{n}{unit}
\PY{g+gp}{\PYZgt{}\PYZgt{}\PYZgt{} }\PY{n}{B} \PY{o}{=} \PY{l+m+mf}{1.0} \PY{o}{*} \PY{n}{unit}\PY{o}{.}\PY{n}{gauss}
\PY{g+gp}{\PYZgt{}\PYZgt{}\PYZgt{} }\PY{n}{B}
\PY{g+go}{\PYZlt{}Quantity 1. G\PYZgt{}}
\PY{g+gp}{\PYZgt{}\PYZgt{}\PYZgt{} }\PY{n}{B}\PY{o}{.}\PY{n}{si}
\PY{g+go}{\PYZlt{}Quantity 0.0001 T\PYZgt{}}

\PY{g+gp}{\PYZgt{}\PYZgt{}\PYZgt{} }\PY{k+kn}{import} \PY{n+nn}{numpy} \PY{k}{as} \PY{n+nn}{np}
\PY{g+go}{Import constants and use them with scalars}
\PY{g+gp}{\PYZgt{}\PYZgt{}\PYZgt{} }\PY{k+kn}{from} \PY{n+nn}{axionbloch}\PY{n+nn}{.}\PY{n+nn}{constants} \PY{k+kn}{import} \PY{n}{gamma\PYZus{}p}
\PY{g+gp}{\PYZgt{}\PYZgt{}\PYZgt{} }\PY{k+kn}{from} \PY{n+nn}{axionbloch}\PY{n+nn}{.}\PY{n+nn}{dependency} \PY{k+kn}{import} \PY{n}{PI}
\PY{g+go}{Find the 90 degree pulse duration}
\PY{g+gp}{\PYZgt{}\PYZgt{}\PYZgt{} }\PY{n}{t90} \PY{o}{=} \PY{n}{PI} \PY{o}{/} \PY{l+m+mi}{2} \PY{o}{/} \PY{p}{(}\PY{n}{gamma\PYZus{}p} \PY{o}{*} \PY{n}{B}\PY{p}{)}
\PY{g+gp}{\PYZgt{}\PYZgt{}\PYZgt{} }\PY{n}{t90}\PY{o}{.}\PY{n}{to}\PY{p}{(}\PY{n}{unit}\PY{o}{.}\PY{n}{microsecond}\PY{p}{)}  
\PY{g+go}{\PYZlt{}Quantity 58.71648793 us\PYZgt{}}
...
\PY{g+gp}{\PYZgt{}\PYZgt{}\PYZgt{} }\PY{n}{phases} \PY{o}{=} \PY{n}{gamma\PYZus{}p} \PY{o}{*} \PY{n}{B} \PY{o}{*} \PY{n}{tStamps}
\PY{g+gp}{\PYZgt{}\PYZgt{}\PYZgt{} }\PY{n}{np}\PY{o}{.}\PY{n}{sin}\PY{p}{(}\PY{n}{phases}\PY{p}{)}
\PY{g+go}{\PYZlt{}Quantity [0. , 0.5, 1. ]\PYZgt{}}
\end{Verbatim}
\end{varwidth}
\end{document}
